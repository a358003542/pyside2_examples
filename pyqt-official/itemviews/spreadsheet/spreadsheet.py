...
from PySide2.QtCore import QDate, QPoint, Qt
from PySide2.QtGui import QColor, QIcon, QKeySequence, QPainter, QPixmap
from PySide2.QtWidgets import (QAction, QActionGroup, QApplication, QColorDialog,
