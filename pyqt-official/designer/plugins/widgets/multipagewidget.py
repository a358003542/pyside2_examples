...
#============================================================================#
# PySide2 port of the designer/containerextension example from Qt v5.x         #
#----------------------------------------------------------------------------#
from PySide2.QtCore import pyqtProperty, pyqtSignal, pyqtSlot, QSize
from PySide2.QtWidgets import (QApplication, QComboBox, QLabel, QStackedWidget,
        QVBoxLayout, QWidget)
