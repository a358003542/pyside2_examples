...
from PySide2.QtCore import Property, Signal, Slot, QPoint, QSize, Qt
...
class HelloGLWidget(QOpenGLWidget):
    ...
    xRotation = Property(int, getXRotation, setXRotation)
    ...
    yRotation = Property(int, getYRotation, setYRotation)
    ...
    zRotation = Property(int, getZRotation, setZRotation)
