...
from PySide2.QtCore import Property, Slot, QPointF, QSize
from PySide2.QtGui import QBrush, QColor, QPainter, QPainterPath, QRadialGradient
...
class PolygonWidget(QWidget):
    ...
    outerRadius = Property(int, getOuterRadius, setOuterRadius)
    ...
    numberOfSides = Property(int, getNumberOfSides, setNumberOfSides)
    ...
    innerColor = Property(QColor, getInnerColor, setInnerColor)
    ...
    outerColor = Property(QColor, getOuterColor, setOuterColor)
