...
from PySide2.QtCore import QFileInfo, QPoint, QRect, Qt, QTime, QTimer
from PySide2.QtGui import (QFontMetricsF, QImage, QPainter, QPixmap, QPolygon,
        QRegion)
from PySide2.QtWidgets import (QApplication, QFrame, QGraphicsScene,
        QGraphicsView, QGraphicsWidget, QMessageBox, QWidget)
from compat import qRound
